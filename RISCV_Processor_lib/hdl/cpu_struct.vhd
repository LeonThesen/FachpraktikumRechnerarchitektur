...
ARCHITECTURE struct OF cpu IS
   ...
   SIGNAL instruction_word_big_endian : word_t;
   ...
   END COMPONENT;
   COMPONENT convert_to_big_endian
   PORT (
   ...
   FOR ALL : convert_to_big_endian USE ENTITY RISCV_Processor_lib.convert_to_big_endian;
   ...
   FOR ALL : io_ram_mux USE ENTITY RISCV_Processor_lib.io_ram_mux;
...
BEGIN
   ...
   convert_to_big_endian_i : convert_to_big_endian
      PORT MAP (
         instruction_word_rom        => instruction_word_rom,
         instruction_word_big_endian => instruction_word_big_endian
      );
