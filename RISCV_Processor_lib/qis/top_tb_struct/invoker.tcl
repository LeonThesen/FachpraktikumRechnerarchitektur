...
if {[is_project_open]} {
   if {[string compare $quartus(project) "top_tb"]} {
      puts "Project top_tb is not open"
      set make_assignments 0
   }
} else {
   # Only open if not already open
   if {[project_exists top_tb]} {
      project_open -revision top_tb top_tb
   } else {
      project_new -revision top_tb top_tb
   }
...
# Make assignments
if {$make_assignments} {
   set_global_assignment -name COMPILER_SETTINGS top_tb
   set_global_assignment -name SIMULATOR_SETTINGS top_tb
   set_global_assignment -name SOFTWARE_SETTINGS top_tb
   set_global_assignment -name FMAX_REQUIREMENT 50MHz
   set_global_assignment -name FAMILY "cyclone v"
   set_global_assignment -name TOP_LEVEL_ENTITY top_tb
   set_global_assignment -name DEVICE 5cgxfc5c6f27c7
   set_global_assignment -name USE_COMPILER_SETTINGS top_tb
	set_global_assignment -name VHDL_FILE "/u/home/clab/st161569/FachpraktikumRechnerarchitektur/RISCV_Processor_lib/hdl/top_tb_entity.vhd" 
	...
	set_global_assignment -name VHDL_FILE "/u/home/clab/st161569/FachpraktikumRechnerarchitektur/RISCV_Processor_lib/hdl/umnudler_entity.vhd" 
	set_global_assignment -name VHDL_FILE "/u/home/clab/st161569/FachpraktikumRechnerarchitektur/RISCV_Processor_lib/hdl/umnudler_behav.vhd" 
	...
	set_global_assignment -name VHDL_FILE "/u/home/clab/st161569/FachpraktikumRechnerarchitektur/RISCV_Processor_lib/hdl/button_entity.vhd" 
	set_global_assignment -name VHDL_FILE "/u/home/clab/st161569/FachpraktikumRechnerarchitektur/RISCV_Processor_lib/hdl/button_behav.vhd" 
	...
	set_global_assignment -name VHDL_FILE "/u/home/clab/st161569/FachpraktikumRechnerarchitektur/RISCV_Processor_lib/hdl/top_tb_struct.vhd" 
