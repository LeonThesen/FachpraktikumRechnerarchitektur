...
HD_PWD='/home/leon/source/srt_verilog/srt_verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_tb.vds -m64 -tempDir . -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_tb.tcl
